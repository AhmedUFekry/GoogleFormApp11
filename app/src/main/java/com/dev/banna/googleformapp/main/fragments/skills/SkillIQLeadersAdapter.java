...
public class SkillIQLeadersAdapter extends RecyclerView.Adapter<BaseViewHolder> {

    public static final int VIEW_TYPE_EMPTY = 0;
    public static final int VIEW_TYPE_SEARCH = 1;

    private Callback mCallback;
    private List<SkillsResponse> mMerchantsList;

    public SkillIQLeadersAdapter(List<SkillsResponse> list) {
        mMerchantsList = list;
    }
    ...
    public void addItems(List<SkillsResponse> list) {
    ...
    public interface Callback {
        void onMerchantClick(SkillsResponse dataBean);
    }
    ...
    public class SearchViewHolder extends BaseViewHolder {
        ...
        public void onBind(int position) {
            ...
            SkillsResponse dataBean = mMerchantsList.get(position);
            ...
            tvDescription.setText(dataBean.getScore() + "," + dataBean.getCountry());
